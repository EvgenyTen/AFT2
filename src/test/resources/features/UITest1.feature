...
Функция: UI 1. Авторизация администратором
  ...
  Сценарий:1. Авторизация администратором
    ...
    То На странице "Заголовок" отображается элемент "Вошли как"
    И На странице "Заголовок" текст элемента "Логин вошедшего пользователя" содержит логин пользователя "Пользователь"
